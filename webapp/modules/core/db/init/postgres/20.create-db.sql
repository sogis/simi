...
alter table SIMIPRODUCT_DATA_PRODUCT add constraint FK_SIMIPRODUCT_DATA_PRODUCT_ON_THERM_GROUP foreign key (THERM_GROUP_ID) references SIMIPRODUCT_THERM_GROUP(ID)^
...
create index IDX_SIMIPRODUCT_DATA_PRODUCT_ON_THERM_GROUP on SIMIPRODUCT_DATA_PRODUCT (THERM_GROUP_ID)^
