...
public class GretlSearchV1 {

    private static Logger log = LoggerFactory.getLogger(GretlSearchV1.class);
    ...
    private GretlSearchV1(String schemaName, String tableName, GretlSearchConfig config){
    ...
    public static List<String> loadGretlDependencies(String[] qualTableName, GretlSearchConfig config){
        GretlSearchV1 query = new GretlSearchV1(qualTableName[0], qualTableName[1], config);
