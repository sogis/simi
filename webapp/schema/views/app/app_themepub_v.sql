 ...
 * jsonb aus. 
 * Jede Zeile umfasst alle Informationen zu einer Themenbereitstellung. Die View wird sowohl in SIMI
 * zwecks Verifikation wie auch im meta2File.jar (CLI-Tool) abgefragt.
 */
...
,themepub AS (
  ...
  JOIN
    tp_bbox bbox ON tp.id = bbox.tp_id
  JOIN 
