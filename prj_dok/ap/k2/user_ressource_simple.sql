...
gdi_oid_resource < 2000 bewirkt, dass nur die ersten ca. 1000 ressourcen selektiert werden,
was der effektiven Anzahl Ressourcen viel eher entspricht.
*/
perm_level AS (
	SELECT 
		id_role, 
...
SELECT * FROM user_ressource_permission
