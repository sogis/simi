...
alter table SIMIFEATUREINFO_LAYER_RELATION add constraint FK_SIMIFEATUREINFO_LAYER_RELATION_ON_FEATURE_INFO foreign key (FEATURE_INFO_ID) references SIMIFEATUREINFO_FEATURE_INFO(ID)^
alter table SIMIFEATUREINFO_LAYER_RELATION add constraint FK_SIMIFEATUREINFO_LAYER_RELATION_ON_DATA_SET_VIEW foreign key (DATA_SET_VIEW_ID) references SIMIPRODUCT_DATA_SET_VIEW(ID)^
create unique index IDX_SIMI_LAYER_RELATION_UNQ_FEATURE_INFO_ID_DATA_SET_VIEW_ID on SIMIFEATUREINFO_LAYER_RELATION (FEATURE_INFO_ID, DATA_SET_VIEW_ID) where DELETE_TS is null ^
create index IDX_SIMIFEATUREINFO_LAYER_RELATION_ON_FEATURE_INFO on SIMIFEATUREINFO_LAYER_RELATION (FEATURE_INFO_ID)^
create index IDX_SIMIFEATUREINFO_LAYER_RELATION_ON_DATA_SET_VIEW on SIMIFEATUREINFO_LAYER_RELATION (DATA_SET_VIEW_ID)^
