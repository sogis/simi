...
create unique index IDX_SIMI_EXTERNAL_MAP_SERVICE_UK_URL on SIMI_EXTERNAL_MAP_SERVICE (URL) where DELETE_TS is null ^
-- end SIMI_EXTERNAL_MAP_SERVICE
-- begin SIMIPRODUCT_EXTERNAL_MAP_LAYERS
alter table SIMIPRODUCT_EXTERNAL_MAP_LAYERS add constraint FK_SIMIPRODUCT_EXTERNAL_MAP_LAYERS_ON_SERVICE foreign key (SERVICE_ID) references SIMI_EXTERNAL_MAP_SERVICE(ID)^
