...
alter table SIMIIAM_PERMISSION add constraint FK_SIMIIAM_PERMISSION_ON_DATA_SET_VIEW foreign key (DATA_SET_VIEW_ID) references SIMIPRODUCT_DATA_SET_VIEW(ID) on delete CASCADE^
...
alter table SIMIDEPENDENCY_RELATION add constraint FK_SIMIDEPENDENCY_RELATION_ON_DEPENDENCY foreign key (DEPENDENCY_ID) references SIMIDEPENDENCY_DEPENDENCY(ID) on delete CASCADE^
alter table SIMIDEPENDENCY_RELATION add constraint FK_SIMIDEPENDENCY_RELATION_ON_DATA_SET_VIEW foreign key (DATA_SET_VIEW_ID) references SIMIPRODUCT_DATA_SET_VIEW(ID) on delete CASCADE^
create unique index IDX_SIMI_RELATION_UNQ on SIMIDEPENDENCY_RELATION (RELATION_TYPE, DEPENDENCY_ID, DATA_SET_VIEW_ID)^
...
alter table SIMI_STYLE_ASSET add constraint FK_SIMI_STYLE_ASSET_ON_DATASET_SET_VIEW foreign key (DATASET_SET_VIEW_ID) references SIMIPRODUCT_DATA_SET_VIEW(ID) on delete CASCADE^
...
alter table SIMIDEPENDENCY_DEPENDENCY add constraint FK_SIMIDEPENDENCY_DEPENDENCY_ON_MAP foreign key (MAP_ID) references SIMIPRODUCT_MAP(ID)^
create index IDX_SIMIDEPENDENCY_DEPENDENCY_ON_MAP on SIMIDEPENDENCY_DEPENDENCY (MAP_ID)^
...
create unique index IDX_SIMIDATA_MODEL_SCHEMA_UNQ_SCHEMA_NAME_POSTGRES_DB_ID on SIMIDATA_MODEL_SCHEMA (SCHEMA_NAME, POSTGRES_DB_ID)^
...
alter table SIMIPRODUCT_PROPERTIES_IN_FACADE add constraint FK_SIMIPRODUCT_PROPERTIES_IN_FACADE_ON_DATA_SET_VIEW foreign key (DATA_SET_VIEW_ID) references SIMIPRODUCT_DATA_SET_VIEW(ID) on delete CASCADE^
...
alter table SIMIPRODUCT_DATA_SET_VIEW add constraint FK_SIMIPRODUCT_DATA_SET_VIEW_ON_ID foreign key (ID) references SIMIPRODUCT_DATA_PRODUCT(ID) on delete CASCADE^
