...
alter table SIMI_PROPERTIES_IN_LIST add constraint UK_SIMI_PROPERTIES_IN_LIST_ON_PRODUCT_LIST_ID_SINGLE_ACTOR_ID unique (PRODUCT_LIST_ID, SINGLE_ACTOR_ID)^
